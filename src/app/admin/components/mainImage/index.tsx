    ...
    return (
      <div className={S.MainImageSlide}>
        ...
        <div className={S.MainIcon}>
          <Image
            alt="icon"
            src="/MainImage/ddang/second.svg"
            width={47}
            height={10}
          ></Image>
        </div>
